...
mongoose.connect('mongodb+srv://admin:admin@cluster0.tmgaz.mongodb.net/thai?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}, function(err){
    if (err){
...
app.get("/luffy", controllerUser.quannam);
app.get("/zoro", controllerUser.aonam);
